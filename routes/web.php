...
Route::group(['prefix' => 'admin'], function() {
    ...
    Route::get('cont/index/{id}', 'Admin\ContsController@index')->middleware('auth');
    
    //Route::get('profile', 'NewsController@profile')->middleware('auth');
});

Route::get('/setlist/index', 'SetlistsController@index')->middleware('auth');
Route::get('/setlist/cont/index/{id}', 'Admin\ContsController@index')->middleware('auth');
...
Route::get('/comment/show/{id}', 'CommentsController@show')->name('comment.show');
